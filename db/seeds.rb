...
j = Journal.create(date: "2021-06-07", user_id: u.id, calories_consumed: 2421)
j2 = Journal.create(date: "2021-05-13", user_id: u.id, calories_consumed: 1851)
j3 = Journal.create(date: "2021-06-02", user_id: u2.id, calories_consumed: 1500)
...
f = Food.create(name: 'Chicky', calories: 10, protein: 1, fat: 0, carb: 0, servinginoz: 1, journal_id: j.id)
f2 = Food.create(name: 'Beeferoni', calories: 10, protein: 1, fat: 0, carb: 0, servinginoz: 1, journal_id: j.id)
