...
j = Journal.create(date: "2021-06-03", user_id: u.id, calories_consumed: 2421)
...
f = Food.create(name: 'Chicky', calories: 10, protein: 1, fat: 0, carb: 0, servinginoz: 1, meal_id: m.id)
f2 = Food.create(name: 'Beeferoni', calories: 10, protein: 1, fat: 0, carb: 0, servinginoz: 1, meal_id: m.id)
